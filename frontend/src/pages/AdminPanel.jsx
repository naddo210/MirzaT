...
//                   py: { xs: 0.5, sm: 1 },
//                   width: { xs: 'auto', md: '100%' },
//                   bgcolor: location.pathname === '/admin/videos' ? 'rgba(26, 35, 126, 0.1)' : 'transparent',
//                   borderRadius: 1,
//                   transition: 'all 0.3s ease',
//                   '&:hover': {
//                     bgcolor: 'rgba(26, 35, 126, 0.15)',
...
//                     '& .MuiTypography-root': {
//                       fontSize: { xs: '0.9rem', sm: '1rem' },
//                       color: location.pathname === '/admin/videos' ? '#1a237e' : 'text.primary',
//                       fontWeight: location.pathname === '/admin/videos' ? 600 : 400
//                     }
//                   }}
//                 />
//               </ListItem>
